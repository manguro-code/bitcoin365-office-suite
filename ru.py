...
class StateManager:
    ...
    def load_state(proc_id: int, range_start: int, range_end: int, tab_type: str = "decimal", program_name: str = "bitcoin365") -> Tuple[int, int, int, dict]:
        ...
        try:
            ...
            print(f"✅ Состояние процесса {proc_id} загружено для вкладки {tab_type}")
...
class PercentRangeWidget(RangeWidget):
    ...
    def __init__(self, parent=None):
        super().__init__("Настройки процентного диапазона: введите от 1 до 1000000", parent)
...
def main():
    ...
    # Добавить аварийный выход в кнопку терминала
    def emergency_exit_to_terminal():
        window.emergency_exit()
    
    # Подключить кнопки "Выход в терминал" с аварийным выходом
